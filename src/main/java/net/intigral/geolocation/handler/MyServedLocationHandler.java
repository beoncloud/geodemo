...
public final class MyServedLocationHandler implements ReqRespHandler {
	private static final Logger log = LogManager.getLogger(MyServedLocationHandler.class);
...
//	public MyServedLocationHandler(final RedissonClient redisson) {
